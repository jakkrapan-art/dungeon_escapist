...
namespace EasyUI.PickerWheelUI
{
    public class PickerWheel : MonoBehaviour
    {
        ...
        [SerializeField] public int minSpinDuration = 0;
        [SerializeField] public int maxSpinDuration = 0;
        ...
        private void DrawPiece(int index)
        {
            ...
            pieceTrns.GetChild(0).GetComponent<Text>().text = piece.pointText;
            pieceTrns.GetChild(1).GetComponent<Text>().text = piece.point.ToString();
